...
public class MMU {
	private final int mem0000Size = 4096;
	private final int memA000Size = 4096;
	private final int memB000Size = 4096;
	private final int memD000Size = 4096;
	...
	MMU() {
		...
		try {
			vhd = new RandomAccessFile("disk.vhd", "rw");
